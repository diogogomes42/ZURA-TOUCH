...
private fun DrawScope.drawWheelDisc(
    ...
    drawCircle(color = Color(0xFF374151), radius = radius + 4f, center = center, style = Stroke(width = 8f))
    ...
    drawCircle(color = ZuraColors.Accent, radius = radius, center = center, style = Stroke(width = 7f))
    drawCircle(color = Color.White.copy(alpha = 0.28f), radius = radius - 2f, center = center, style = Stroke(width = 1.5f))
}
